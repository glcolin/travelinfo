...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Restaurants"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($restaurants as $restaurant) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $restaurant['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $restaurant['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $restaurant['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $restaurant['info']['title']?></td>
            <td class="center"><?php echo $restaurant['info']['category_title']?></td>
            <td class="center"><?php echo $restaurant['info']['create_date']?></td>
            <td class="center"><?php echo $restaurant['info']['update_date']?></td>
            <td class="right"><?php foreach ($restaurant['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=restaurants/restaurants/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=restaurants/restaurants';
