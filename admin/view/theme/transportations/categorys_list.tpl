...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Categorys"; ?></h1>
      ...
      <textarea id="sort_string" name="sort_string" style="display:none;"></textarea>
        <table class="list">
          ...
          <?php foreach ($categorys as $category) { ?>
            ...
            <td class="center"><?php echo $category['info']['create_date']?></td>
            <td class="center"><?php echo $category['info']['update_date']?></td>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=transportations/categorys/saveSort',
		dataType : "html",
		data: {
