...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Transportations"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($transportations as $transportation) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $transportation['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $transportation['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $transportation['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $transportation['info']['title']?></td>
            <td class="center"><?php echo $transportation['info']['category_title']?></td>
            <td class="center"><?php echo $transportation['info']['create_date']?></td>
            <td class="center"><?php echo $transportation['info']['update_date']?></td>
            <td class="right"><?php foreach ($transportation['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=transportations/transportations/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=transportations/transportations';
