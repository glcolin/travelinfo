...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Shopping Addresses"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($shoppings as $shopping) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $shopping['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $shopping['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $shopping['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $shopping['info']['title']?></td>
            <td class="center"><?php echo $shopping['info']['category_title']?></td>
            <td class="center"><?php echo $shopping['info']['create_date']?></td>
            <td class="center"><?php echo $shopping['info']['update_date']?></td>
            <td class="right"><?php foreach ($shopping['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=shoppings/shoppings/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=shoppings/shoppings';
