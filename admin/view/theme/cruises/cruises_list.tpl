...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Cruises"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($cruises as $cruise) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $cruise['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $cruise['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $cruise['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $cruise['info']['title']?></td>
            <td class="center"><?php echo $cruise['info']['category_title']?></td>
            <td class="center"><?php echo $cruise['info']['create_date']?></td>
            <td class="center"><?php echo $cruise['info']['update_date']?></td>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=cruises/cruises/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=cruises/cruises';
