...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Attractions"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($attractions as $attraction) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $attraction['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $attraction['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $attraction['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $attraction['info']['title']?></td>
            <td class="center"><?php echo $attraction['info']['category_title']?></td>
            <td class="center"><?php echo $attraction['info']['create_date']?></td>
            <td class="center"><?php echo $attraction['info']['update_date']?></td>
            <td class="right"><?php foreach ($attraction['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=attractions/attractions/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=attractions/attractions';
