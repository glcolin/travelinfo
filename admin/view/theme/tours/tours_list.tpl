...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Tours"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($tours as $tour) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $tour['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $tour['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $tour['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $tour['info']['title']?></td>
            <td class="center"><?php echo $tour['info']['category_title']?></td>
            <td class="center"><?php echo $tour['info']['create_date']?></td>
            <td class="center"><?php echo $tour['info']['update_date']?></td>
            <td class="right"><?php foreach ($tour['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=tours/tours/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=tours/tours';
