...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Hotels"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($hotels as $hotel) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $hotel['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $hotel['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $hotel['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $hotel['info']['title']?></td>
            <td class="center"><?php echo $hotel['info']['category_title']?></td>
            <td class="center"><?php echo $hotel['info']['create_date']?></td>
            <td class="center"><?php echo $hotel['info']['update_date']?></td>
            <td class="right"><?php foreach ($hotel['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=hotels/hotels/saveSort',
		dataType : "html",
		data: {
...
function filter() {
	url = 'index.php?route=hotels/hotels';
