...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Friendlinks"; ?></h1>
      ...
      <textarea id="sort_string" name="sort_string" style="display:none;"></textarea>
        <table class="list">
          ...
          <?php foreach ($friendlinks as $friendlink) { ?>
            ...
            <td class="center"><?php echo $friendlink['info']['create_date']?></td>
            <td class="center"><?php echo $friendlink['info']['update_date']?></td>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=home/friendlinks/saveSort',
		dataType : "html",
		data: {
