    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general">General</a></div>
		...
		<table class="form">
          ...
          <tr>
			<td> Banner link:</td>
			<td><input name="banner_link[<?php echo $language['language_id']; ?>]" value="<?php echo isset($banner_info[$language['language_id']]['link']) ? $banner_info[$language['language_id']]['link'] : ''; ?>" size="100"/>
			</td>
		  </tr>
          <tr>
            ...
            <select name="banner_position[<?php echo $language['language_id']; ?>]">
                ...
                <option value="content" <?php echo isset($banner_info[$language['language_id']]['position'])?($banner_info[$language['language_id']]['position']=='content'?'selected="selected"':''):''?>>Content</option>
            </select>
			</td>
		  </tr>
          <tr>
