...
<div id="content">
  ...
  <div class="box">
  	<div class="heading">
      <h1><img src="view/image/product.png" alt="" /> <?php echo "Advertisements"; ?></h1>
        ...
        <table class="list">
          ...
          <?php foreach ($advertisements as $advertisement) { ?>
            ...
            <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $advertisement['info']['id']; ?>" />
                <input type="hidden" name="pid" value="<?php echo $advertisement['info']['id']; ?>" />
            </td>
            <td class="center"><img src="<?php echo $advertisement['image']?>" style="padding: 1px; border: 1px solid #DDDDDD;"/></td>
            <td class="center"><?php echo $advertisement['info']['title']?></td>
            <td class="center"><?php echo $advertisement['info']['create_date']?></td>
            <td class="center"><?php echo $advertisement['info']['update_date']?></td>
            <td class="right"><?php foreach ($advertisement['action'] as $action) { ?>
...
function save_sort(){
	...
	$.ajax({
		type: 'post',
		url : 'index.php?route=home/advertisements/saveSort',
		dataType : "html",
		data: {
