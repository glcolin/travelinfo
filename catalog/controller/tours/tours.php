...
class ControllerToursTours extends Controller {
	public function index() {
		...
		$header_banners = $this->model_tours_tours->getBanners($data);
		...
		$categorys = $this->model_tours_tours->getCategorys($data);
		...
		$items = $this->model_tours_tours->getItems($data);
		$data=array(
			"category"=>$current_category,
			"search"=>$search,
			"language_id"=>$language
		);
		$items_total = $this->model_tours_tours->getItems($data);
