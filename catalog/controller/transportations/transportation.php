<?php  
class ControllerTransportationsTransportation extends Controller {
	public function index() {
		$this->document->setTitle("America Travel Info");
	
		$this->load->model('transportations/transportation');
		...
		$header_banners = $this->model_transportations_transportation->getBanners($data);
		...
		$categorys = $this->model_transportations_transportation->getCategorys($data);
		...
		$this->data['item'] = $this->model_transportations_transportation->getItem($data);

		$this->template = 'transportations/transportation.tpl';
