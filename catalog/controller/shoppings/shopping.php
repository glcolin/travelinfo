<?php  
class ControllerShoppingsShopping extends Controller {
	public function index() {
		$this->document->setTitle("America Travel Info");
	
		$this->load->model('shoppings/shopping');
		...
		$header_banners = $this->model_shoppings_shopping->getBanners($data);
		...
		$categorys = $this->model_shoppings_shopping->getCategorys($data);
		...
		$this->data['item'] = $this->model_shoppings_shopping->getItem($data);

		$this->template = 'shoppings/shopping.tpl';
