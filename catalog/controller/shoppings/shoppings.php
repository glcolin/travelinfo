...
class ControllerShoppingsShoppings extends Controller {
	public function index() {
		...
		$header_banners = $this->model_shoppings_shoppings->getBanners($data);
		...
		$this->session->data['class_title'] = "shopping";
		$data=array(
			"language_id"=>$language
		);
		$categorys = $this->model_shoppings_shoppings->getCategorys($data);
		...
		//items
		$ids=array();
		if(isset($this->session->data['shoppings_ids'])){
			$ids = $this->session->data['shoppings_ids'];
		}
		$this->data['ids'] = $ids;
		...
		$items = $this->model_shoppings_shoppings->getItems($data);
		$data=array(
			"category"=>$current_category,
			"search"=>$search,
			"language_id"=>$language
		);
		$items_total = $this->model_shoppings_shoppings->getItems($data);
		...
		$this->template = 'shoppings/shoppings.tpl';
