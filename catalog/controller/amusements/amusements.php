...
class ControllerAmusementsAmusements extends Controller {
	public function index() {
		...
		$header_banners = $this->model_amusements_amusements->getBanners($data);
		...
		$categorys = $this->model_amusements_amusements->getCategorys($data);
		...
		//items
		$ids=array();
		if(isset($this->session->data['amusements_ids'])){
			$ids = $this->session->data['amusements_ids'];
		}
		$this->data['ids'] = $ids;
		...
		$items = $this->model_amusements_amusements->getItems($data);
		$data=array(
			"category"=>$current_category,
			"search"=>$search,
			"language_id"=>$language
		);
		$items_total = $this->model_amusements_amusements->getItems($data);
		...
		$this->template = 'amusements/amusements.tpl';
