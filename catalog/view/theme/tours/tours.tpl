  ...
  <div class="contents">
    ...
    <div class="artical">
      ...
      <div class="sbimglist">
        ...
        <?php $item_link=$item['custom_link']=="yes"?$item['website']:'./index.php?route=tours/tour&cid='.$current_category.'&item_id='.$item['item_id'];?>
        <div class="newslist"> <a href="<?php echo $item_link;?>"><img src="./uploads/images/<?php echo $item['image_url'];?>" class="mainImg" width="230" height="160"/></a>
          <div class="newsinfo"> <a href="<?php echo $item_link;?>">
            ...
            <div class="listinfo">
                            <p class="listinfot width100" style="margin-right:0;"><?php echo $TEXT['visits'];?>:</p>
                            <div style="text-indent:0;padding-left:100px;"><?php echo $item['visits'];?></div> 
 			</div>
            <div class="listinfo">
