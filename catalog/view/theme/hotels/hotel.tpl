...
<div id="wrap">
  ...
  <div class="contents"> <?php echo $column_left;?>
    <div class="artical">
      ...
      <div class="sbimglist">
        <div class="newslist hotellist"> <a target="_blank" href="./uploads/images/<?php echo $item['image_url'];?>"><img width="240" height="130" src="./uploads/images/<?php echo $item['image_url'];?>"></a>
          <div class="newsinfo">
