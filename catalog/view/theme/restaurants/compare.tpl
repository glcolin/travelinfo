...
<div id="wrap">
  ...
  <div class="contents"> 
      <div class="breadcrume"> <a href="./index.php"><?php echo $TEXT['home'];?></a> > <a href='./index.php?route=restaurants/restaurants' ><?php echo $TEXT['restaurants'];?></a> > <span class="current"><a href='./index.php?route=restaurants/restaurants&cid=<?php echo $current_category;?>' ><?php echo $category_title;?></a></span> </div>
      <div class="table">
        ...
        <ul class="nobgrow ">
          <li class="compname noborder Category" style="height: 40px;"><?php echo $TEXT['restaurant_category'];?></li>
          <li class="compcontents Category" style="height: 40px;"><?php echo isset($items[0]['restaurant_category'])?$items[0]['restaurant_category']:"";?></li>
          <li class="compcontents Category" style="height: 40px;"><?php echo isset($items[1]['restaurant_category'])?$items[1]['restaurant_category']:"";?></li>
          <li class="compcontents width271 Category" style="height: 40px;"><?php echo isset($items[2]['restaurant_category'])?$items[2]['restaurant_category']:"";?></li>
        </ul>
        <ul class="bgrow ">
          <li class="compname noborder Category" style="height: 40px;"><?php echo $TEXT['business_hours'];?></li>
          <li class="compcontents Category" style="height: 40px;"><?php echo isset($items[0]['business_hours'])?$items[0]['business_hours']:"";?></li>
          <li class="compcontents Category" style="height: 40px;"><?php echo isset($items[1]['business_hours'])?$items[1]['business_hours']:"";?></li>
          <li class="compcontents width271 Category" style="height: 40px;"><?php echo isset($items[2]['business_hours'])?$items[2]['business_hours']:"";?></li>
        </ul>
        <ul class="nobgrow ">
