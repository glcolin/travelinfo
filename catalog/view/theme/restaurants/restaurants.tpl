  ...
  <div class="contents"> <?php echo $column_left;?>
    <div class="artical">
      ...
      <div class="sbimglist">
        ...
        <?php $item_link=$item['custom_link']=="yes"?$item['website']:'./index.php?route=restaurants/restaurant&cid='.$current_category.'&item_id='.$item['item_id'];?>
        <div class="newslist"> <a href="<?php echo $item_link;?>"><img src="./uploads/images/<?php echo $item['image_url'];?>" class="mainImg" width="230" height="160"/></a>
          <div class="newsinfo"> <a href="<?php echo $item_link;?>">
            ...
            <div class="listinfo">
              <p class="listinfot width100" style="margin-right:0;"><?php echo $TEXT['restaurant_category'];?>:</p>
              <div style="text-indent:0;padding-left:100px;"><?php echo $item['restaurant_category'];?></div>
            </div>
            <div class="listinfo">
              <p class="listinfot width100" style="margin-right:0;"><?php echo $TEXT['business_hours'];?>:</p>
              <div style="text-indent:0;padding-left:100px;"><?php echo $item['business_hours'];?></div>
            </div>
            <div class="listinfo">
...
<input type="hidden" id="class_type" value="restaurants" />
