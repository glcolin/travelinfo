  ...
  <div class="contents"> <?php echo $column_left;?>
    <div class="artical">
      ...
      <div class="sbimglist">
        ...
        <?php $item_link=$item['custom_link']=="yes"?$item['website']:'./index.php?route=transportations/transportation&cid='.$current_category.'&item_id='.$item['item_id'];?>
...
<input type="hidden" id="class_type" value="transportations" />
