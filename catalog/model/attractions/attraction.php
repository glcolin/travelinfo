<?php
class ModelAttractionsAttraction extends Model {	
	...
	public function getItem($data=array()){
		$query = $this->db->query("SELECT * from aa_attractions where language_id='".$data['language_id']."' and item_id='".$data['item_id']."' ");
		$row=$query->row;
